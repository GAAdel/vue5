<template>
        <div id="app">
            ...
            <div>
                <label>Фамилия:</label>
                <input type="text" placeholder="Гарипов" v-model="params.secondName"/>
            </div> 
            ...
            <div>
                <label>Имя:</label>
                <input type="text" placeholder="Адель" v-model="params.firstName"/>
            </div>
            ...
            <div>
                ...
                <input type="text" placeholder="Равилевич" v-model="params.patronymic"/>
            </div> 
            ...
            <div>
                ...
                <input type="text"  placeholder="89775674567" v-model="params.phone"/>
            </div> 
...
export default {
        ...
        methods: {
            ...
            updateData() {
                try {
                    this.$http.get('http://localhost:3000/mas').then((res) => res.json()).then((res) => (this.mas = res));
                } catch (e) {
                    console.error(e);
                }
            },
